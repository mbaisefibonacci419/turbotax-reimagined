        ...
        {progressPct > 0 && progressPct < 100 && (
          <div className="progress">
            ...
            <div className="progress__sections">
              <div className="progress__section">My info</div>
              <div className="progress__section">Federal</div>
              <div className="progress__section">State</div>
              <div className="progress__section">Review & file</div>
            </div>
          </div>
        )}
