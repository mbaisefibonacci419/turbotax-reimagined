...
const STEP_FIELD_EXTRACTORS: Record<string, (tr: TaxReturn, calc?: CalculationResult) => string | undefined> = {
  ...
  expense_scanner: (_tr, _calc) => {
    return 'User is viewing the "Smart Expense Scanner" page where they upload bank/credit card transaction exports and IntuitAssist categorizes them by tax relevance (business expenses, medical, charitable, home office, etc.). See deductionFinderContext for categorization results.';
  },
