    ...
    <ToolViewWrapper>
      <SectionIntro
        ...
        description={isPrivate
          ...
          : 'Upload transactions, select what to look for, and let IntuitAssist categorize your expenses by tax relevance.'
        }
      />
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mb-3">
                ...
                for tax-relevant expenses. IntuitAssist categorizes every transaction by
