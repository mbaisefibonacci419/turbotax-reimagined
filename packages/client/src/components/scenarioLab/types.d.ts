...
export type VariableCategory = 'personal' | 'income_wage' | 'income_investment' | 'income_se' | 'retirement' | 'deductions' | 'credits';
export declare const CATEGORY_LABELS: Record<VariableCategory, string>;
export declare const SCENARIO_COLORS: readonly ["blue", "violet", "emerald", "orange"];
