 ...
 */
export type StepCondition = FieldEqualsCondition | FieldExistsCondition | FieldTruthyCondition | ArrayNotEmptyCondition | ArrayLengthGtCondition | DiscoveryEqualsCondition | AgiLteCondition | AnyCondition | AllCondition | NotCondition;
