...
export interface StateFieldMapping {
    ...
    checkWhen?: (value: unknown, taxReturn: TaxReturn, calc: CalculationResult, stateResult: StateCalculationResult) => boolean;
    /** Custom transform to compute the value (overrides sourcePath resolution) */
    transform?: (taxReturn: TaxReturn, calc: CalculationResult, stateResult: StateCalculationResult) => string | boolean | undefined;
}
...
export interface StateFormTemplate {
    ...
    condition: (taxReturn: TaxReturn, calc: CalculationResult, stateResult: StateCalculationResult) => boolean;
