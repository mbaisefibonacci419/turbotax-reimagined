...
export type IRSFieldFormat = 'string' | 'dollarNoCents' | 'dollarCents' | 'integer' | 'ssn' | 'ssnPartial' | 'checkbox' | 'date';
...
export interface IRSFormTemplate {
     ...
     */
    fieldsForInstance?: (index: number, taxReturn: TaxReturn, calc: CalculationResult) => IRSFieldMapping[];
}
